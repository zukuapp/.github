<p align="center">
  <a href="https://trecillo.crevision.kr"><img src="profile/assets/developer-hero.png" alt="Trecillo · ZUKU 개발자 문서" width="960"></a>
</p>

# zukuapp 개발 문서와 공통 안내

이 저장소의 [`profile/README.md`](profile/README.md)는 [zukuapp 조직 홈](https://github.com/zukuapp)에 표시됩니다. 개발자가 공개 도구와 계약을 찾을 수 있도록 조직 프로필, 문서 허브, 공통 기여 안내를 관리합니다. **Trecillo**가 공식 영문 표기입니다.
...
1. 기능과 계약의 사실 관계는 해당 공개 저장소의 README·명세에서 확인합니다. 공개되지 않은 문서나 배포되지 않은 패키지를 입문 경로로 안내하지 않습니다.
2. 조직 홈의 문구와 링크는 [`profile/README.md`](profile/README.md)를 수정합니다. 개발 문서의 공통 설명은 [`docs/`](docs/README.md)에 두고 저장소별 상세 사용법은 소유 저장소로 연결합니다.
