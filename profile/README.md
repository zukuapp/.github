...
`zuku-cli`는 명령 이름만 갖춘 **시제품**으로, 현재 생성·검증·패키징·업로드 작업을 수행하지 않습니다. API 명세 역시 운영 API나 SDK 배포를 뜻하지 않습니다. [저장소별 상태](https://zukuapp.github.io/docs/#repositories)를 확인하세요.
